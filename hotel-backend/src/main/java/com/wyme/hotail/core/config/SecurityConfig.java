...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(Arrays.asList("Authorization", "Content-Type", "X-Tenant-ID", "x-owner-email", "x-recipient-email", "x-hotel-id", "x-hotel-name", "x-hotel-city", "x-hotel-phone"));
